...
import de.bushnaq.abdalla.engine.audio.synthesis.util.LiniarCubeActor;
import de.bushnaq.abdalla.engine.audio.synthesis.util.TranslationUtil;
import org.junit.jupiter.api.Test;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class LiniarTranslationTest extends TranslationUtil {
    protected static final int    NUMBER_OF_SOURCES = 10;
    private final          Logger logger            = LoggerFactory.getLogger(this.getClass());
    LiniarCubeActor[] ccaa = new LiniarCubeActor[NUMBER_OF_SOURCES];

    @Override
    public void create() {
        super.create();
        for (int i = 0; i < NUMBER_OF_SOURCES; i++) {
            ccaa[i] = new LiniarCubeActor(i, 0);
