...
//    boolean isSilent();
     ...
     * if it si a spaken message, it needs to be generated by the chat agent first,
     * then spoken by the TTS engine.
     *
     * @param rr The RadioRequest containing the message details.
     */
    void processRadioMessage(RadioRequest rr);
