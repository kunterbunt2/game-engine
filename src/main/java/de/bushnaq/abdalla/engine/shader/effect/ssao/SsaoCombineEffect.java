...
public class SsaoCombineEffect<T extends RenderEngineExtension> extends ShaderVfxEffect implements ChainVfxEffect {
    ...
    public SsaoCombineEffect(VfxManager vfxManager, final FrameBuffer postFbo, final MovingCamera camera, Ssao ssao) {
    ...
    public void render(final VfxRenderContext context, final VfxFrameBuffer src, final VfxFrameBuffer dst) {
        ...
        src.getFbo().getColorBufferTexture().bind(TEXTURE_HANDLE1);
